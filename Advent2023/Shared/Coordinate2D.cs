...
public class Coordinate2D
{
    ...
    public Coordinate2D ShiftX(long shift) => new Coordinate2D(X + shift, Y);
    public Coordinate2D ShiftY(long shift) => new Coordinate2D(X, Y + shift);
    public Coordinate3D ShiftZ(long shift) => new Coordinate3D(X, Y, shift);
    ...
    public long IntegerDistance(Coordinate2D second) { return (long)Distance(second); }
    ...
    public long IntegerDistance(long x, long y) { return (long)Distance(x, y); }
