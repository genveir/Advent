...
namespace Advent2021.Advent22
{
    class Tests
    {
        ...
        [TestCase(ZOnlyInv, 3)]
        [TestCase(Covered, 0)]
        [TestCase(CornerLow, 1000 - 125)]
        [TestCase(CornerHigh, 1000 - 125)]
        [TestCase(Subsumed, 1000 -125)]
        [TestCase(Fails, 0)]
        [TestCase(XAndY, 5)]
        ...
        [TestCase(part2Example, 2758514936282235)]
        ...
        public const string XOnly = @"
on  x=10..12, y=1..1,    z=1..1
off x=11..13, y=1..1,    z=1..1";

        public const string XOnlyInv = @"
off x=11..13, y=1..1,    z=1..1
on  x=10..12, y=1..1,    z=1..1";

        public const string YOnly = @"
on  x=1..1,   y=10..12,  z=1..1
off x=1..1,   y=11..13,  z=1..1";

        public const string YOnlyInv = @"
off x=1..1,   y=11..13,  z=1..1
on  x=1..1,   y=10..12,  z=1..1";

        public const string ZOnly = @"
on  x=1..1,   y=1..1,    z=10..12
off x=1..1,   y=1..1,    z=11..13";

        public const string ZOnlyInv = @"
off x=1..1,   y=1..1,    z=11..13
on  x=1..1,   y=1..1,    z=10..12";
...
off x=1..10,  y=1..10,   z=1..10";
        ...
        public const string CornerLow = @"
on  x=1..10, y=1..10,  z=1..10
off x=1..5,  y=1..5,   z=1..5";

        public const string CornerHigh = @"
on  x=1..10, y=1..10,  z=1..10
off x=6..10, y=6..10,  z=6..10";

        public const string Subsumed = @"
on  x=1..10, y=1..10,  z=1..10
off x=2..6,  y=2..6,   z=2..6";

        public const string Fails = @"
on  x=1..1,   y=1..1,    z=10..12
off x=1..49, y=1..49,  z=1..49";
...
on x=10..10,y=10..10,z=10..10";
        ...
        public const string part2Example = @"on x=-5..47,y=-31..22,z=-19..33
